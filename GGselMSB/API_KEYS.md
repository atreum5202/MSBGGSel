...
> V1 и V2 в GGSEL Seller API. **НЕ УДАЛЯТЬ И НЕ ПЕРЕИМЕНОВЫВАТЬ** — панель GGselV7
...
```ini
# config.py
GGSEL_API_KEY   = "2fe4d6b0a6b3aecd858b83353338a9b563a8d3361eab0bbc55e24f8adeb9761b"
...
- В GUI ключ показан только в превью-формате: `2fe4d6b0…adeb9761b` (8 + 4 символа).
